...
[log]
summary = _on or off: log brief summary of connection and statements_
connection = _on or off: log connection details_
statement = _on or off: log SQL statements_
duration = _on or off: log elapsed time of completed statements_

[security]
secret_key = _encryption key: do not edit_
----
